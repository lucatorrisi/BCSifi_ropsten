        ...
        while True:
            ...
            for response in self._cur:
                ...
                if(self._lastentry<response[0]):
                    ...
                    contract_address = Web3.toChecksumAddress("0x498dce6759c6649e18402b2005a895f6b90c8b86")
                    ...
                    uniqueIdentifier = random.getrandbits(128);
                    ...
                    transactionQuery = 'UPDATE transactions set addressOwner="'+addressProcessOwner+'", transactionAddress="'+hash.hex()+'", transactionTimestamp = "'+tsTimestampStr+'", uniqueIdentifier =%s where id=%s'
